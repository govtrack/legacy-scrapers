...
) ENGINE=MyISAM AUTO_INCREMENT=412497 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
) ENGINE=MyISAM AUTO_INCREMENT=43013 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `people_videos` (
  ...
  KEY `date` (`date`),
  KEY `link` (`link`(127))
) ENGINE=MyISAM AUTO_INCREMENT=12374939 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `people_committees` (
  ...
  KEY `personid` (`personid`)
) ENGINE=MyISAM AUTO_INCREMENT=158571 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2011-01-23 17:06:56
