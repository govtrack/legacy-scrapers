...
) ENGINE=MyISAM AUTO_INCREMENT=412586 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
) ENGINE=MyISAM AUTO_INCREMENT=43498 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `people_videos` (
  ...
  KEY `date` (`date`),
  KEY `link` (`link`(127))
) ENGINE=MyISAM AUTO_INCREMENT=14025413 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `people_committees` (
  ...
  KEY `personid` (`personid`)
) ENGINE=MyISAM AUTO_INCREMENT=194890 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2013-01-02 19:19:52
