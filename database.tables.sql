...
) ENGINE=MyISAM AUTO_INCREMENT=43014 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `people_videos` (
  ...
  KEY `date` (`date`),
  KEY `link` (`link`(127))
) ENGINE=MyISAM AUTO_INCREMENT=12836028 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2011-05-27 12:11:03
